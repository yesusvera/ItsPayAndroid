package itspay.br.com.util.component;
...
/**
 * Created by juniorbraga on 15/05/17.
 */
...
public class BorderTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            String typefaceName = a.getString( R.styleable.BorderTextView_typeface);
            if(typefaceName != null) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
                setTypeface(tf);
            }

            if(a.hasValue(R.styleable.BorderTextView_custmobackground)){
                Drawable foreground = a.getDrawable(R.styleable.BorderTextView_custmobackground);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.BorderTextView_custmobackground, 0xff000000));
                }
            }

            if(a.hasValue(R.styleable.BorderTextView_custmobackground)){
                Drawable background = a.getDrawable(R.styleable.BorderTextView_custmobackground);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.BorderTextView_custmobackground, 0xff000000));
                }
            }

            if(a.hasValue(R.styleable.BorderTextView_innerShadowColor)){
                this.addInnerShadow(a.getDimensionPixelSize(R.styleable.BorderTextView_innerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.BorderTextView_innerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.BorderTextView_innerShadowDy, 0),
                        a.getColor(R.styleable.BorderTextView_innerShadowColor, 0xff000000));
            }

            if(a.hasValue(R.styleable.BorderTextView_outerShadowColor)){
                this.addOuterShadow(a.getDimensionPixelSize(R.styleable.BorderTextView_outerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.BorderTextView_outerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.BorderTextView_outerShadowDy, 0),
                        a.getColor(R.styleable.BorderTextView_outerShadowColor, 0xff000000));
            }
